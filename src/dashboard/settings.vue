    ...
    <div class="btn-control-panel" @click="preventHide" v-show="panelShow">
      <ul class="current-panel" v-show="currentPanel">
        <li>
          <span class="item-name">
            {{$vueCoreVideoPlayer_t('dashboard.settings.autoplay')}}
          </span>
        ...
        <li>
          <span class="item-name" >{{$vueCoreVideoPlayer_t('dashboard.settings.loop')}}</span>
          <div class="item-control">
            <widgets-switch ref="loopSwitch" @change="changeLoopSettings"></widgets-switch>
          </div>
        </li>
        <li>
          <span class="item-name">{{$vueCoreVideoPlayer_t('dashboard.settings.speed')}}</span>
        ...
        <li v-show="medias.length > 1">
          <span class="item-name">{{$vueCoreVideoPlayer_t('dashboard.settings.resolution')}}</span>
      ...
      <ul class="resolution-list animated fadeInRight" v-show="resolutionListPanel">
        <li @click="backCurrentPanel">
          ...
          {{$vueCoreVideoPlayer_t('dashboard.btn.back')}}
        </li>
